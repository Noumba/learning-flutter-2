...
class _ChatScreenState extends State<ChatScreen> {
  ...
  List<String> _suggestedReplies = [
    ...
    'Good Morning',
    'Hope you fine',
    'Sorry am running late',
    'Please am not available now',
    'Can we see later?',
    'Thanks for the Information, am really thankful',
    'Merry Christmas',
          ...
          if (snapshot.hasData) {
            ...
            return new ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Column(
                    mainAxisAlignment: snapshot.data[index].isMe == 1
                        ? MainAxisAlignment.end
                        : MainAxisAlignment.start,
                    crossAxisAlignment: snapshot.data[index].isMe == 1
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  color: snapshot.data[index].messageType ==
                                          ...
                                          snapshot.data[index].isMe == 1
                                      ? Colors.lightBlueAccent
                                      : snapshot.data[index].messageType ==
                                                  MessageType.text.toString() &&
                                              snapshot.data[index].isMe == 2
                                          ? Colors.white70
                                          : Colors.transparent,
                                  borderRadius: BorderRadius.only(
                                      topLeft: snapshot.data[index].isMe == 1
                                          ? Radius.circular(24)
                                          : Radius.zero,
  ...
  Future<void> _takePicture() async {
    ...
    var messageToSend =
        Messages(dbSavedImage, MessageType.image.toString(), isMe);
                                  ...
                                  ? GestureDetector(
                                      onTap: () {
                                        ...
                                        if (sentMessageCount % 2 == 0) {
                                          dbHelper.insertTextMessage(Messages(
                                              _suggestedReplies[rand.nextInt(
                                                  _suggestedReplies.length)],
                                              MessageType.text.toString(),
                                              2));
                                        }
                                      },
